...
echo $Calculator->calc("/", 112, 0); //will output Cannot divide by zero
echo $Calculator->calc("*", 10, 2); //will output The product of the numbers is 20
//echo $Calculator->calc("*", 11110, 2); //code to make sure output is appropriate for not just the provided test code (it works)
