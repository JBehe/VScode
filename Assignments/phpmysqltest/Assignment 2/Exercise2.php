...
<meta charset="UTF-8">
    ...
    //this is for the main section of the webpage
    ...
    <!-- php snippit and code is the way that the webpage will be formated-->
    <title> <?php echo $mywebpage ?> </title>
    ...
    <style>
        * {margin: 0; padding: 0;}
        ...
        footer {background: #eeee; padding: 10px 0; text-align: center}
